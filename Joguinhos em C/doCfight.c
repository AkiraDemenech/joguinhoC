...
void game () {
	...
	do {
		...
		do {
			...
			printf("| %d CHANCE",lp); if(lp>1) { printf("S"); }
			printf("              "); SetConsoleTextAttribute (hConsole, 12);
			...
			if(fc[100]==4 && rand()%5>0) {
				lp--;
				xp = rand()%666;
				yp = rand()%666;
				if(lp>0) {
					gotoxy(15,20); sleep(1); printf("\a");
			...
			cl++; fx[100] = xp; fy[100] = yp; fc[100] = 0; xp+=dx; yp+=dy;
			if(xp>665) { xp = 665; }
			if(yp>665) { yp = 665; }
			if(xp<0) { xp = 0; }
			if(yp<0) { yp = 0; }
...
void intro () {
	...
	printf("OF YOUR ");
	SetConsoleTextAttribute (hConsole, 11);
	printf("DELTA SPACE SQUADRON");
	sleep(1); SetConsoleTextAttribute (hConsole, 15);
	printf("\n\n          PRESS P TO PAUSE THE GAME");
	sleep(1); SetConsoleTextAttribute (hConsole, 10);
	printf("\n\n          PRESS UP (or W) TO REVERT FLIGHT");
	sleep(1);
	printf("\n          PRESS DOWN (or S) TO KEEP FLYING FORWARD");
	sleep(1);
	printf("\n          PRESS RIGHT (or A) or LEFT (or D) TO TURN YOUR DELTA");
	sleep(1);
	printf("\n          PRESS SPACE or ENTER TO SHOOT");
	sleep(1); SetConsoleTextAttribute (hConsole, 11);
	printf("\n\n          YOU ARE BLUE");
	sleep(1); SetConsoleTextAttribute (hConsole, 10);
	printf("\n\n          YOUR FRIENDS ARE GREEN");
	sleep(1); SetConsoleTextAttribute (hConsole, 12);
	printf("\n\n          YOUR ENEMIES ARE RED");
